...
export const projects: Project[] = [
  {
    id: '1',
    title: 'Weblens',
    description: 'A fullstack web application built with next.js, Redis, and Render. Weblens is a tool for webdevelopers to quickly test their websites for SEO and accessibility issues. It provides a comprehensive report on the websites performance.',
    image: 'Weblens.png',
    link: 'https://web-lens-brown.vercel.app/',
  },
  {
    id: '2',
    title: 'IT Toolkit',
